...
2. Open [Activity 3: Exploring the repository and the notebook](/cdcf-workshop2B/activity3/).
3. Open [Activity 4: Experimenting with the code](/cdcf-workshop2B/activity4/).
4. Bonus activity: Play around with another repository:
    - How significant are the public dimensions of faculty work in review, promotion, and tenure documents? (Alperin et al., 2018) 
      ...
      - Reproduced Repo (data & code): <https://github.com/data-curation/rpt-project>  
